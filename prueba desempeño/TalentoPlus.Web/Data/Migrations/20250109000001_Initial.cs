        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NivelEducativo = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    PerfilProfesional = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Departamento de IT y desarrollo", "Tecnología" },
                    { 2, "Gestión de personal", "Recursos Humanos" },
                    { 3, "Comercial y ventas", "Ventas" },
                    { 4, "Contabilidad y finanzas", "Finanzas" },
                    { 5, "Operaciones y logística", "Operaciones" }
                });
